...
import {addDays, addHours, startOfDay, addMinutes, setDate, setDay, subDays } from 'date-fns'
...
export class AppointmentsComponent implements OnInit {
  ...
  createTitle(appointment : Appointment) : string {
    return this.examinationTypes[appointment.examType] + "\n"
           + appointment.patient.firstName + " " + appointment.patient.lastName + "\n"
           + appointment.room.floor.building.name + ", Floor: " + appointment.room.floor.number + ", Room: " + appointment.room.number
  }
